...
def SplitImage2(input_path='./Train_LR/', output_path='./Train_LR_sub/', fsub_size=33):
    # オリジナルの訓練データの読み込み
    input_img_list = glob.glob(input_path + '*')
...
if __name__ == '__main__':
    ...
    MakeLowResolutionImage(org_path='./Test/Train/', redu_path='./Test/Train_LR/', redu_rate=2)
